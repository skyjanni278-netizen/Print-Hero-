...
| Taste | Aktion            | Energie-Kosten | Beschreibung                              |
|-------|-------------------|---------------|-------------------------------------------|
...
**Energie-Regeneration:** +3 Energie pro Runde automatisch.
...
Nach jedem Sieg wird Loot pro Gegner gewürfelt. Die Anzahl der Würfe hängt vom **Rang** des Gegners ab (siehe Tabelle oben).
...
Es gibt drei Ausrüstungsslots: **Waffe**, **Rüstung**, **Helm**.  
Epic & Legendär sind nur durch Loot erhältlich — nicht im Shop.

### Waffen

| Stufe     | Name             | ATK  | Quelle        | Verkaufswert |
|-----------|------------------|-----:|---------------|------------:|
...
| Stufe      | Name                | DEF  | Quelle        | Verkaufswert |
|------------|---------------------|-----:|---------------|------------:|
...
Schrott hat keinen Effekt — er ist ausschließlich zum Verkaufen beim Händler.

| Item          | Emoji | Verkaufswert |
|---------------|-------|------------:|
| Altes Seil    | 🪢    | 3 Gold      |
| Lumpen        | 🧣    | 2 Gold      |
| Knochen       | 🦴    | 4 Gold      |
...
Alte Saves werden automatisch auf neue Formate migriert (neuer Inventaraufbau, Helm-Slot etc.).
